...
//   const PIDTuningPage({Key? key, required this.onValueChanged})
//       : super(key: key);
...
//   void _updateValue(String parameter, double value) {
//     if (_debounce?.isActive ?? false) _debounce!.cancel();
//     _debounce = Timer(const Duration(milliseconds: 300), () {
//       widget.onValueChanged(parameter, value);
//     });
//   }
...
//               onChanged: (value) {
//                 setState(() => _kp = value);
//                 _updateValue("Kp", value);
//               },
//             ),
//             Text("Ki: ${_ki.toStringAsFixed(2)}"),
//             Slider(
//               value: _ki,
//               min: 0,
//               max: 1000,
//               onChanged: (value) {
//                 setState(() => _ki = value);
//                 _updateValue("Ki", value);
//               },
//             ),
//             Text("Kd: ${_kd.toStringAsFixed(4)}"),
//             Slider(
//               value: _kd,
//               min: 0.001,
//               max: 1.0,
